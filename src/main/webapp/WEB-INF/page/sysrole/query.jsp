...
<head>
 ...
 <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      	<div class="app-title">
        	<div>
          		<h1><i class="fa fa-user"></i>用户设置</h1>
          		<ul class="app-breadcrumb breadcrumb">
          		<li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          		<li class="breadcrumb-item">系统设置</li>
          		<li class="breadcrumb-item"><a href="#">用户设置</a></li>
        	</div>
        	<div><a class="btn btn-primary btn-flat" href="#"><i class="fa fa-lg fa-plus"></i></a>
        		<a class="btn btn-info btn-flat" href="#"><i class="fa fa-lg fa-pencil"></i></a>
		...
		<div class="row">
        	<div class="col-md-12">
          		<div class="tile">
            		<div class="tile-body">
              			<table class="table table-hover table-bordered" id="sysUserTable">
                			<thead>
				            	<tr>
				            		<th></th>
				               		<th>用户编码</th>
    ...
    <script type="text/javascript">
    	...
    	$('#sysUserTable').DataTable({
    		...
    		ajax: {
                ...
                url: "<%=basePath%>/sysUser/query.action", 
                type: "POST",
                data: function(param) {
                	//添加额外的参数传给服务器
                 	param.extra_search = {
