 ...
 <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      	...
      	<div class="row">
      		<div class="col-md-12">
          		<div class="tile">
          			<form action="<%=basePath%>/sysCode/save.action">
          				<div class="row">
	              			<div class="col-lg-5">
	                  			<div class="form-group row">
				                	<label class="control-label col-md-3">基础数据类型</label>
					                <div class="col-md-8">
				                    	<input class="form-control" name="pubCode" type="text" placeholder="基础数据类型">
				                  	</div>
				                </div>
				                <div class="form-group row">
				                	<label class="control-label col-md-3">中文名称</label>
					                <div class="col-md-8">
				                    	<input class="form-control" name="pubCName" type="text" placeholder="中文名称">
				                  	</div>
				                </div>
				                <div class="form-group row">
	                		...
	                		<div class="col-lg-5 offset-lg-1">
	                			<div class="form-group row">
					                ...
					                <div class="col-md-8">
				                    	<input class="form-control" name="pubValue" type="text" placeholder="基础数据值">
				                  	</div>
				                </div>
	                 			<div class="form-group row">
				                	<label class="control-label col-md-3">英文名称</label>
					                <div class="col-md-8">
				                    	<input class="form-control" name="pubEName" type="text" placeholder="英文名称">
				                  	</div>
				                </div>
	                		</div>
	                	</div>
